...
## fgn_sim.R
##
## This script contains the primary function for simulatiing discrete samples of Fractional Gaussian Noise.
## Included are several different simulation methods (Hosking, Cholesky, Davies-Harte, etc.) to provide the user
...
#'
#' @description Returns a sample of fractional Gaussian noise of size N
#'
...
#' @examples
#' \dontrun{
#' FGN(1000, 0.25, 1.0, 'davies-harte)
#' }
#' \dontrun{
#' FGN(1000, 0.25, 1.0, 'hosking)
#' }
#' \dontrun{
